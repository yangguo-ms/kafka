...
trait OffsetMap {
  ...
  def init(strategy: String, headerKey: String, cleanerThreadId: Int, topicPartitionName: String): Unit
...
class SkimpyOffsetMap(val memory: Int, val hashAlgorithm: String = "MD5") extends OffsetMap with Logging {
   ...
   */
  override def init(strategy: String = Defaults.CompactionStrategy, headerKey: String = "", cleanerThreadId: Int = -1, topicPartitionName: String = ""): Unit = {
